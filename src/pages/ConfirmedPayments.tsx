...
export default function ConfirmedPayments() {
  ...
  const buildReportData = () => {
    ...
    const headers = [
      ...
      'Payment Date', 'Amount', 'Balance', 'Payer', 'Bank', 'Bank Ref', 'Payment Confirmed By', 'Released By',
      // 'Ticket Generated By',
    ];
    ...
    exportSorted.forEach((p, idx) => {
      ...
      rows.push([
        ...
        p.payment_confirmed_by_name || '—', p.released_by_name || '—',
              ...
              <Table>
                ...
                <TableBody>
                  {isLoading ? (
                    ...
                    <TableRow>
                      <TableCell colSpan={18} className="text-center h-24 text-slate-500">
